...
public class ETLYoutubeVideosRunner implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(ETLYoutubeVideosRunner.class);
		
		job.setMapperClass(ETLYoutubeVideosMapper.class);
	...
	public static void main(String[] args) {
		try {
			int resultCode = ToolRunner.run(new ETLYoutubeVideosRunner(), args);
			if(resultCode == 0){
